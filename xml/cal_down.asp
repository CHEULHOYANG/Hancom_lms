...
sql="select ordnum from cal_gu_mast where idx='"& cnum(1) &"' and sid='"& cnum(0) &"'"
...
sql = "select idx,ordnum from cal_gu_mast where ordnum > '"& now_order &"' and sid='"& cnum(0) &"' order by ordnum desc"
...
sql = "update cal_gu_mast set ordnum = '"& change_order_num &"' where idx= '"& cnum(1) &"'"
db.execute sql,,adexecutenorecords

sql = "update cal_gu_mast set ordnum = '"& now_order &"' where idx= '"& change_idx &"'"
db.execute sql,,adexecutenorecords
