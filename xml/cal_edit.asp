...
sql = "select top 1 ordnum from cal_gu_mast where sid = '"& cnum(0) &"' order by ordnum desc"
...
title = Tag2Txt(cnum(1))
bg_color = Tag2Txt(cnum(2))
font_color = Tag2Txt(cnum(3))

sql = "update cal_gu_mast set title ='"& title & "' , bg_color = '"& bg_color &"' , font_color = '"& font_color &"' where sid = '"& cnum(0) &"' and idx = '"& cnum(4) &"'"
