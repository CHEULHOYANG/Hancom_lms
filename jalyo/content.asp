    ...
    <div class="content">
        ...
        <%End if%>      
            ...
            <table class="ftbl" style="width:830px">
                    ...
                    <tbody>
						<tr>
							<td colspan="3"><%=content%><% if not image1 = "" then %><br /><br /><img src="../img/disk.png" align="absmiddle">&nbsp;<span onclick="go2dwn(<%=strProg%>);" style="cursor:pointer;"><u><%=image2%></u></span><%End if%></td>
						</tr>
                    </tbody>
                </table>
