...
Dim einfo1,einfo2,einfo3,einfo4,einfo5,einfo6,einfo7,einfo8,einfo9,einfo10,regdate,idx

sql="select title,id,info1,info2,info3,info4,info5,info6,info7,info8,info9,info10,regdate,idx from end_paper where id = '"& str_User_ID &"' and idx = "& request("idx")
set rs=db.execute(sql)
...
sql = "Update end_paper set print_check = print_check + 1 where idx = "& request("idx")
...
.license{background:url(/yes_rad/sub3_end_paper/paper.jpg) no-repeat center -20px;width:618px;height:960px;padding:130px 190px 180px 190px; font-family:'Nanum Gothic','Malgun Gothic',dotum,sans-serif;color:#111;font-size:21px;letter-spacing:3px;line-height:30px}
