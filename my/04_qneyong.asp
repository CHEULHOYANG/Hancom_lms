...
if Not quserid = str_User_ID then
	viewPage = False
end if
...
<%End if%>
            ...
            <div class="cbtn"> <% if str_User_ID = quserid then %><a href="javascript:delLicen();" class="mbtn grey">삭제하기</a><%End if%> <a href="04_qlist.asp?intpg=<%=intpg%>&<%=varPage%>" class="mbtn">목록으로</a> </div>
