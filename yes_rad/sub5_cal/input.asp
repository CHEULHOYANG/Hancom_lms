...
dim sid,sql,rs,board_count,idx,title,bg_color,font_color

sid = "cal_"& year(date) & month(date) & day(date) & hour(time) & minute(time) &second(time) &""
%>
...
<input type="hidden" name="sid" value="<%=sid%>">	
		<table class="ftbl mb50" style="width:100%">
				...
				<tbody>
					...
					<tr>
						<th>일정스킨형태</th>
						<td><input name="gu" type="radio" value="0" checked> 
                달력형&nbsp;&nbsp;
                <input type="radio" name="gu" value="1"> 
                목록형</td>
					</tr>
					<tr>
						<th>구분</th>
						<td><input name="bun" type="radio" value="0" checked onClick="cal_display(0);"> 사용&nbsp;&nbsp;
<input type="radio" name="bun" value="1" onClick="cal_display(1);"> 미사용</td>
					</tr>
					<tr>
						<th>표시출력설정</th>
						<td><input name="s_type" type="radio" value="0" checked> 분류명&nbsp;&nbsp;
<input type="radio" name="s_type" value="1"> 제목&nbsp;&nbsp;
                <input type="radio" name="s_type" value="2"> 분류명+제목</td>
					</tr>
				</tbody>
			</table>
</form>
