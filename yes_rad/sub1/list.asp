...
Dim sns_kakao,sns_naver1,sns_naver2,sql,rs,huday,player1,player2,watermark,google_pwd,player3
Dim kullus1,kullus2

sql = "select kakao,naver1,naver2,huday,player1,player2,watermark,google_pwd,player3,kullus1,kullus2 from site_info"
