...
<form name="regfm" action="nwrite_ok.asp" method="post" style="display:inline;"> 
		<table class="ftbl mb50" style="width:100%">
				...
				<tbody>
					<tr>
						<th>제목</th>
						<td><input type="text"  name="jemok" class="inptxt1 w400">&nbsp;<input type="checkbox" name="notice" id="checkbox" value="1" /> 공지</td>
					</tr>
					<tr>
						<th>내용</th>
		...
		<div class="rbtn">
			...
			<a href="nlist.asp" class="btn trans">목록보기</a>		
		</div>
