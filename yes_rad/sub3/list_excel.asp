...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<td width="11%" height="30" align="center" style="BORDER-BOTTOM: #000 1px solid; BORDER-TOP: #000 1px solid; BORDER-LEFT: #000 1px solid">접속횟수</td>
...
If Len(request("gm")) = 0 then

sql = "select idx,id,pwd,name,juminno1,juminno2,tel1,tel2,email,zipcode1,zipcode2,juso1,juso2,mileage,regdate,state,login_count,b_year,b_month,b_day,b_type,sms_res,email_res,sp1,sp2,sp3,memo from member order by idx desc"
...
%>
  <tr>
    <td height="25" align="center" style="BORDER-BOTTOM: #cccccc 1px solid; BORDER-LEFT: #cccccc 1px solid"><%=rs(0)%></td>
    ...
    <td height="25" align="center" style="BORDER-BOTTOM: #cccccc 1px solid; BORDER-LEFT: #cccccc 1px solid"><%=rs(4)%></td>
	...
	<td align="center" style="BORDER-BOTTOM: #cccccc 1px solid; BORDER-LEFT: #cccccc 1px solid"><%=rs(16)%>회</td>
