...
<%
Dim sql,rs,name,ordnum,s_idx,deep
...
sql = "select top 1 ordnum from dan_category where uidx = "& s_idx &" and deep=1 order by ordnum desc"
...
sql = "insert into dan_category (title,ordnum,uidx,deep,img)values"
sql = sql & "('" & name & "'"
sql = sql & "," & ordnum
sql = sql & "," & s_idx
sql = sql & "," & deep
...
response.write"self.location.href='m_input.asp?s_idx="& s_idx &"';"
