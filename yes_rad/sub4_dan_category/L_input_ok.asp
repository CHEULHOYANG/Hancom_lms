...
sql = "select top 1 ordnum from dan_category where deep=0 order by ordnum desc"
...
sql = "insert into dan_category (title,ordnum,img,state)values"
sql = sql & "('" & name & "'"
sql = sql & "," & ordnum
sql = sql & ",'" & image1 &"'"
sql = sql & "," & state
...
response.write"self.location.href='L_input.asp';"
