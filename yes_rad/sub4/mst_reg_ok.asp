...
Dim strnm,intprice,intgigan,sajin,recom,strheader,lecnum,gbn,icon,sub_title,mem_group,teacher,state,book_idx
...
sql = "insert into LectMast (idx,strnm,intprice,intgigan,strheader,icon,gbn,sajin,recom,sub_title,mem_group,teacher,state,book_idx,ordn) values ("
sql = sql & idxnum & ",'"
sql = sql & strnm & "',"
sql = sql & intprice & ","
sql = sql & intgigan & ",'"
...
sql = sql & recom & ",'"
sql = sql & sub_title & "','"
sql = sql & mem_group & "','"& teacher &"',"& state &",'"& book_idx &"',"
sql = sql & ordnum
sql =  sql & ")"
db.execute(sql)
