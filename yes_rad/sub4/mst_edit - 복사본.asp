...
dim strnm,intprice,intgigan,strheader,sajin,recom,gbn,ordn,icon,sub_title,mem_group,teacher,state
...
sql = "select strnm,intprice,intgigan,strheader,sajin,recom,gbn,ordn,icon,sub_title,mem_group,teacher,state from LectMast where idx=" & idx
