...
<div class="container">
	...
	<div class="content">
		<h2 class="cTit"><span class="bullet"></span>패키지매출통계</h2>

		<div class="tbl_top">
			<form name="form" method="post" action="mstlist.asp"><select name="yy" class="seltxt w100"><%
										dim y : y = 0
...
<% if isRecod then
						...
						<tr >
							<td colspan="3"><%=yy%>년 <%=mm%>월 패키지 매출 없습니다.</td>
						</tr><% end if %>
			</tbody>
		</table>
