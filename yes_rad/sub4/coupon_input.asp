...
<div class="container">
	...
	<div class="content">
		<h2 class="cTit"><span class="bullet"></span><%If request("gu") = 2 Then response.write"단과" Else response.write"패키지" End if%> 무료수강 쿠폰등록</h2>
...
<input type="hidden" name="gu" value="<%=request("gu")%>">
		<table class="ftbl mb50" style="width:100%">
				...
				<tbody>
					...
					<tr>
						<th><%If request("gu") = 2 Then response.write"단과" Else response.write"패키지" End if%>선택</th>
...
%>								
		...
		<div class="caution"><p>한줄에 하나씩 번호를 입력</p></div>
