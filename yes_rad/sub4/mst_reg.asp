...
%>
					...
					<tr>
						...
						<td><select name="gbn" class="seltxt w200">
								<option value="">카테고리선택</option><% sql = "select idx,bname from mscate order by idx"
					...
					<tr>
						<th>메인표출</th>
						<td> <input type="checkbox"  name="recom" value="1">  메인페이지에 표출 (<input type="text"  name="teacher" class="inptxt1 w200" placeholder="메인표시내용">)</td>
					</tr>
					<tr>
						<th>강의아이콘</th>
						<td><%
			...
			<table width="100%" cellpadding="0" cellspacing="0">
						...
						<tr>
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="0">
								...
								<tr height="25">
									<td height="35" align="center" ><input type="button" value="추가 삭제" class="btnss" style="width:80px;" onClick="removeItem(this.form);"></td>
								</tr>
								<tr height="25">
									<td height="35" align="center" ><input type="button" value="정렬올리기 ▲" class="btnss" style="width:80px;" onClick="upItem(this.form);"></td>
								</tr>
								<tr height="25">
									<td height="35" align="center" ><input type="button" value="정렬내리기 ▼" class="btnss" style="width:80px;" onClick="downItem(this.form);"></td>
								</tr>
							</table>							</td>
...
<p style="height:10px"></p>
		<div class="rbtn">
			...
			<a href="mst_list.asp" class="btn trans">목록보기</a>		
		</div>
