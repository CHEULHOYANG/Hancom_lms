...
sql = "select idx,bname,cnt = (select count(idx) from Lectmast where gbn = A.idx),ordnum from mscate A order by ordnum"
...
if(isKey || event) event.returnValue = false;
	...
	sndReq("sub3xml/dancate_xml.asp",params,viewCate,"POST");
}
...
if(isKey || event) event.returnValue = false;
	...
	sndReq("sub3xml/dan_edite_xml.asp",params,viewCate,"POST");	
}
...
function CateDelete(cateidx,rcdNum){
	if(parseInt(rcdNum,10) > 0 ){
		...
		sndReq("sub3xml/dancatedel_xml.asp",params,delView,"POST");	
	}
}
...
function ordSun(){
	...
	sndReq("sub3xml/danord_xml.asp",params,orderView,"POST");
}
          ...
          <tr>
            ...
            <td width="880"><table border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="15" align="center"><img src="../yes_rad_img/a_img/page/i_cate.gif" width="5" height="9" /></td>
                <td class="grey2_1"><strong>패키지분류관리</strong></td>
      ...
      <tr>
        ...
        <td width="88%" valign="top"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<table width="100%" border="0" cellpadding="0" cellspacing="0">
										<tr height="100">
											<td width="100%" align="center">등록된 카테고리 없습니다</td>
										</tr>
										<tr height="20">
											<td></td>
										</tr>
          ...
          <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr height="20">
              <td><p style="margin:5px 0 5px 0"><img src="/yes_manage/yes_rad_img/help.gif" align="absmiddle"></p></td>
            </tr>
            <tr height="20">
              <td width="100%" height="23">- 패키지강좌를 등록하시기전에 전에 카테고리를 먼저 등록하셔야 합니다.</td>
            </tr>
            <tr height="20">
              <td height="23">- 분류가 2개 이상인경우 위아래버튼을 이용해서 순서를 변경할수 있습니다.</td>
            </tr>
            <tr height="20">
              <td height="23">&nbsp;</td>
            </tr>
