		...
		<table class="ftbl" style="width:980px">
				...
				<tbody>
					...
					<tr>
						...
						<td><input type="text" name="zipcode1" id="post1" class="inptxt1 w50" tabindex="12" readonly /> <a href="javascript:openDaumPostcode();" class="fbtn">우편번호</a></td>
					</tr>
					<tr>
						<td><input type="text" name="juso1" id="addr" class="inptxt1 w600" tabindex="13" readonly /></td>
					</tr>
					<tr>
						<td><input type="text" name="juso2" id="addr2" class="inptxt1 w600" tabindex="14" /></td>
					</tr>
					<tr>
						<th>수신여부</th>
