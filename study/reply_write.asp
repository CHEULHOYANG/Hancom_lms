...
<input type="hidden" name="dntGbn" value="<%=request("dntGbn")%>">
<input type="hidden" name="categbn" value="<%=request("categbn")%>">
<input type="hidden" name="intpg" value="<%=request("intpg")%>">
            ...
            <div class="cbtn"> <a href="javascript:reply_send();" class="mbtn grey">작성완료</a> <a href="javascript:history.go(-1);" class="mbtn">취소하기</a> </div>
